...
// Fallback view for Node kinds whose dedicated view isn't built yet (voice rooms,
// documents). Keeps navigation coherent while those land in later slices.
  ...
  return (
    <section className="flex min-w-0 flex-1 flex-col items-center justify-center gap-2 bg-card p-8 text-center">
      ...
      <p className="max-w-sm text-sm text-muted-foreground">
        ...
        (document, voice room) arrives in a later slice — open{' '}
